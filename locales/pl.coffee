...
landingWhatyoucan:
  ...
  section2Path: "Dzięki temu możesz pokazać konkretną scieżkę lub drogę lub udostępnić możliwość eksploracji dla przeglądających."
  section2See: "Zobacz co możnesz zrobić na naszej"
...
i18nIm:
  ...
  lostFound: "To może być twoje zdjęcie. W związku z problemem z aplikacją na Androida v. 24, nie jesteśmy w stanie zlokalizować kto jest właścicielem tego zdjęcia. Jeśli Ty nim jesteś, zostaw komentarz pod tym zdjęciem, lub podeślij mejla na hello@mapillary.com."
